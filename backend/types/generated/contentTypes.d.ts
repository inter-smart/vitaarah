...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blogListingSection: Schema.Attribute.Component<
      'sections.blog-listing-section',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiConditionCondition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    recommended_treatments_section: Schema.Attribute.Component<
      ...
      false
    >;
    related_root_causes: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiConsultationConsultation
  ...
  attributes: {
    ...
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    requested_treatment: Schema.Attribute.Relation<
      'oneToOne',
      'api::treatment.treatment'
    >;
    slug: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGalleryPageGalleryPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    galleryListSection: Schema.Attribute.Component<
      'sections.gallery-list-section',
      false
    >;
    hero: Schema.Attribute.Component<'sections.inner-hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    related_programs: Schema.Attribute.Relation<
      'oneToMany',
      'api::program.program'
    >;
    short_description: Schema.Attribute.Text;
...
export interface ApiRootCauseRootCause extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    related_conditions: Schema.Attribute.Relation<
      'manyToMany',
      'api::condition.condition'
    >;
...
export interface ApiTreatmentTreatment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    related_treatment_category: Schema.Attribute.Relation<
      ...
      'api::treatment-category.treatment-category'
    >;
    related_treatments_section: Schema.Attribute.Component<
