              ...
              <ul className="">
                {data?.description
                  ...
                  ?.children?.map((item, id) => (
                    <li
                      key={id}
                      className="text_3 text-[#A14962] font-helvetica-light not-last-of-type:mb-[10px] not-last-of-type:xl:mb-[12px] not-last-of-type:2xl:mb-[16px] not-last-of-type:3xl:mb-[20px] relative flex items-start gap-[10px] 2xl:gap-[15px] 3xl:gap-[20px] before:relative before:content-[''] before:block before:w-[10px] before:xl:w-[12px] before:h-[10px] before:xl:h-[12px] before:top-[4px] before:xl:top-[6px] before:bg-[url('/images/dotList.svg')] before:bg-cover before:bg-no-repeat before:p-[5px]"
                    >
