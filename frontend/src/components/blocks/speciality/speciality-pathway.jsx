            ...
            <div className="container">
                ...
                <div className="flex flex-wrap justify-between items-center gap-[15px]">
                    ...
                    <div className="flex items-center gap-[10px]">
                        ...
                        <a href={data?.ctaSection?.whatsapp?.Url} className="w-[32px] 2xl:w-[37px] 3xl:w-[45px] h-[32px] 2xl:h-[37px]
                                ...
                                hover:shadow-[0_15px_40px_rgba(161,73,98,0.35)]" aria_label={data?.ctaSection?.whatsapp?.label}>
