        ...
        <section className='relative py-[30px_45px] lg:py-[30px_60px] xl:py-[45px_80px] 2xl:py-[55px_120px] 3xl:py-[70px_150px]'>
            <div className="container">
                ...
                <div className="w-full flex flex-wrap border-t border-r border-[#C3C3C3] mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px]">
                    ...
                    {data?.specialities.map((item, idx) => (
                        <div className="w-full   sm:w-1/2 md:w-1/3 border-b border-l border-[#C3C3C3]" key={idx} >
                            <div className="w-full h-full block p-[20px] md:p-[20px_15px] xl:p-[30px_25px] 2xl:p-[40px_35px] 3xl:p-[50px_45px]">
                                <div className="w-[45px] xl:w-[55px] 2xl:w-[65px] 3xl:w-[85px] h-[45px] xl:h-[55px] 2xl:h-[65px] 3xl:h-[85px] rounded-full border border-[#A7546C] overflow-hidden p-[10px] xl:p-[12px] 2xl:p-[15px] 3xl:p-[20px] mb-[10px] 2xl:mb-[15px] 3xl:mb-[20px]">
                ...
                <div className="flex flex-wrap justify-between items-center gap-[15px]">
                    <div className="text_3 mb-0">{data?.footerText}</div>
                    <div className="flex items-center gap-[10px]">
                        ...
                        <a href={data?.whatsapp?.Url} className="w-[32px] 2xl:w-[37px] 3xl:w-[45px] h-[32px] 2xl:h-[37px]
                                ...
                                hover:shadow-[0_15px_40px_rgba(161,73,98,0.35)]" aria_label={data?.whatsapp?.label}>
                            <div className="xl:p-[5px] 2xl:p-[8px] 3xl:p-[10px] flex">
                                <svg  className="w-[18px] xl:w-[20px] 2xl:w-[22px] 3xl:w-[24px]" viewBox="0 0 24 24" fill="none" >
                                    <g clip-path="url(#clip0_2178_7860)">
