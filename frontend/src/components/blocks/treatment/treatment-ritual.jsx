          ...
          <div className="flex items-center gap-[10px] xl:gap-[25px] max-lg:flex-wrap">
            ...
            <div className="w-full lg:w-3/12 lg:flex lg:justify-end">
              <ConsultationForm>
                ...
                text-white font-medium inline-flex items-center justify-center px-[8px] min-w-[120px] xl:min-w-[150px] 2xl:min-w-[170px] 3xl:min-w-[205px]
                h-[32px] 2xl:h-[37px] 3xl:h-[45px] transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-[1.03]
                hover:shadow-[0_15px_40px_rgba(161,73,98,0.35)] cursor-default"
                >
                  <span
