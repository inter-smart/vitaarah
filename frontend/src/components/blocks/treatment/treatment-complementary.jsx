...
export default function TreatmentComplementary({ data }) {
    ...
    return (
        <section className='relative py-[25px] lg:py-[30px] xl:py-[35px] 2xl:py-[45px_35px] 3xl:py-[55px_40px]'>
                    ...
                    <div className="absolute inset-y-0 left-0 right-0 z-30 pointer-events-none">
                        ...
                        >
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.0513 0.351562L0.70254 13.8759L14.0513 27.4003" stroke="black" />
                                <line y1="-0.5" x2="26.3468" y2="-0.5" transform="matrix(1 -5.961e-08 -1.28212e-07 -1 0.877441 13.875)" stroke="black" />
                            </svg>
                        ...
                        >
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.1729 0.351562L26.5216 13.8759L13.1729 27.4003" stroke="black" />
                                <line x1="26.3467" y1="14.375" x2="-8.62318e-05" y2="14.375" stroke="black" />
                            </svg>
