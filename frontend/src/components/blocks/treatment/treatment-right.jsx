...
export default function TreatmentRight({ data, commitmentDetails, treatmentSlug }) {
  const detailsList = [
    { label: "Duration", value: commitmentDetails?.duration_info },
    { label: "Sessions", value: commitmentDetails?.sessions_info },
    { label: "Frequency", value: commitmentDetails?.fequency_info },
    { label: "Best time", value: commitmentDetails?.best_time_info },
          ...
          >
            <div className="w-full h-full p-[30px_20px] md:p-[55px_35px] lg:p-[75px_45px] xl:p-[90px_65px] 2xl:p-[105px_75px_110px] 3xl:p-[130px_100px_140px] bg-gradient-to-r from-[#E9CBA3] to-[#A14962]">
              ...
              {data?.button_label && (
                ...
                >
                  <ConsultationForm treatmentSlug={treatmentSlug}>
                    <div className="group relative overflow-hidden bg-gradient-to-r from-[#A14962] via-[#C16C84] to-[#E9CBA3] text-white font-medium inline-flex items-center justify-center px-[8px] min-w-[180px] xl:min-w-[225px] 2xl:min-w-[260px] 3xl:min-w-[325px] h-[42px] xl:h-[52px] 2xl:h-[60px] 3xl:h-[75px] transition-all duration-500 ease-out hover:shadow-[0_15px_40px_rgba(161,73,98,0.35)] cursor-default">
