...
export default function TreatmentAlchemy({ data }) {
    ...
    return (
        <section className='relative py-[40px_20px] lg:py-[60px_30px] xl:py-[90px_50px] 2xl:py-[100px_60px] 3xl:py-[140px_85px] overflow-hidden'>
                ...
                <div className="flex flex-wrap w-full">
                    ...
                    >
                        <div className="w-full h-full">
                            ...
                            <div className="text_3 font-light mb-[15px] lg:mb-[20px] xl:mb-[30px] 2xl:mb-[35px] 3xl:mb-[40px]">
                                {data?.subtitle}
                            </div>
                    ...
                    <div className="w-full lg:w-[calc(100%-330px)] xl:w-[calc(100%-400px)] 2xl:w-[calc(100%-460px)] 3xl:w-[calc(100%-578px)] lg:pl-[30px] xl:pl-[40px] 2xl:pl-[60px] 3xl:pl-[80px]">
                        ...
                        >
                            {data?.benefits.map((item, id) => (
                                ...
                                >
                                    <motion.div
                                        className="w-full h-full border-[#CFCFCF] border-b border-l p-[12px] md:p-[15px] lg:p-[20px] xl:p-[25px] 2xl:p-[30px] 3xl:p-[40px] hover:bg-[#FFF9EB]"
