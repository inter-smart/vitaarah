...
const inputStyle = "text-[#875849] placeholder:text-[#875849] border-black/20 focus:border-black";
                ...
                <div className="flex flex-wrap max-lg:gap-[20px]">
                    <div className="lg:w-4/12">
                        <div className="w-full">
                            <div className="heading_1 mb-[15px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[35px]">{data.title}</div>
                            <div className="text_3 font-light mb-[25px] xl:mb-[35px] 2xl:mb-[45px] 3xl:mb-[55px]">{data.description}</div>

                            <a href={`/${data?.whatsappButton?.slug}`}
                            ...
                            >
                                <div className="w-[25px] 2xl:w-[27px] 3xl:w-[35px] h-[25px] 2xl:h-[27px]
                                3xl:h-[35px] flex items-center justify-center bg-[#00A85A] transition-all duration-500 ease-out 
                                " aria_label={data?.whatsapp?.label}>
                                ...
                                <span className="text_3  relative z-10">
                                    {data?.whatsappButton?.label}
                                </span>
                            </a>
                        </div>
                    </div>
                                        ...
                                        {(field) => {
                                            ...
                                            return (
                                                <Field
                                                    ...
                                                    className="w-full sm:w-1/2 flex  "
                                                >
                                                    <FieldLabel className="sr-only" htmlFor="Primary-Concern">
                                                        Primary Concern*
                                                    </FieldLabel>
                                                    <Select
                                                        name={field.name}
