            ...
            <div className="container">
                ...
                <Swiper
                    ...
                    {data?.rootCauses.map((item, index) => (
                        <SwiperSlide
                            key={index}
                            className="!h-auto group transition-all "
                        >
                            <div key={"services" + index} className="relative block w-full h-full bg-white lg:bg-[#FFFCF5] p-[30px_10px] lg:p-[43px_15px] xl:p-[55px_18px] 2xl:p-[60px_20px] 3xl:p-[73px_55px] 
