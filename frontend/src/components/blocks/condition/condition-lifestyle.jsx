    ...
    <section className="relative bg-[#FFF9EB] py-[40px] md:py-[50px] lg:py-[70px_90px] xl:py-[88px_110px] 2xl:py-[100px_130px] 3xl:py-[120px_165px]">
      <div className="container">
        ...
        {(data?.lifestyle_card || []).map((item, idx) => (
          <div
            key={"lifestyle_card" + idx}
            className={`w-full h-full bg-white p-[15px] lg:p-[18px] xl:p-[22px] 2xl:p-[25px] 3xl:p-[32px] flex flex-wrap mb-[20px] lg:mb-[25px] xl:mb-[35px] 2xl:mb-[45px] 3xl:mb-[55px] last:mb-0 ${
              idx % 2 !== 0 ? "sm:flex-row-reverse" : ""
            }`}
          >
            {/* Image */}
            <div className="w-full sm:w-[220px] md:w-[280px] lg:w-[330px] xl:w-[420px] 2xl:w-[475px] 3xl:w-[595px] aspect-[595/340] max-sm:mb-[15px]">
              <Image
                src={
            ...
            {/* Content */}
            <div
              className={`w-full sm:w-[calc(100%-220px)] md:w-[calc(100%-280px)] lg:w-[calc(100%-330px)] xl:w-[calc(100%-420px)] 2xl:w-[calc(100%-475px)] 3xl:w-[calc(100%-595px)] flex items-center ${
                idx % 2 !== 0
            ...
            >
              <div className="w-full">
                ...
                <ul>
                  {(item?.description?.[0]?.children || []).map(
                    (contentItem, id) => (
                      <li
                        key={id}
