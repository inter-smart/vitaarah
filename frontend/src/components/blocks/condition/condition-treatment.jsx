			...
			<div className="container">
				...
				<Swiper
					...
					{data?.treatments.map((item, index) => (
						<SwiperSlide key={index} className="!h-auto group  border border-[#C3C3C3] not-first-of-type:!border-l-0 "	>
							<div className="w-full h-full bg-wite p-[30px_15px] sm:p-[45px_25px] md:p-[50px_35px] lg:p-[60px_40px] xl:p-[70px_50px] 2xl:p-[75px_60px] 3xl:p-[75px_73px] text-center transition-all hover:bg-[#FFF9EB]">
								<div className="text_3 text-[#5D5D5D] uppercase font-light mb-[8px]">{item?.tag}</div>
