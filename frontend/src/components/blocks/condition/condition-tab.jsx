  ...
  return (
    <section className="relative pt-[35px] lg:pt-[45px] xl:pt-[55px] 2xl:pt-[65px] 3xl:pt-[77px]">
      <div className="container">
        <div className="w-full md:max-w-[93%] h-[65px] xl:h-[75px] 2xl:h-[85px] 3xl:h-[105px] flex items-center justify-center mx-auto px-[10px] md:px-[20px] lg:px-[50px]  xl:px-[60px] 2xl:px-[70px] 3xl:px-[80px] bg-white shadow-[inset_4px_2px_15px_-6px_rgba(0,0,0,0.08)]">
          <Swiper
          ...
          >
            {data.map((item, id) => {
              ...
              return (
                <SwiperSlide key={"ConditionTab" + id} className="!h-auto">
                  <Link
