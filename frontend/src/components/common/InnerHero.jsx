        ...
        <section className="relative py-[20px]">
            <div className="container">
                <div className="relative w-full h-[250px] md:h-[285px] xl:h-[350px] 2xl:h-[400px] 3xl:h-[500px] w-full flex items-end overflow-hidden px-[25px] py-[30px]">
                    ...
                    {/* Content */}
                    <div className="relative z-10 w-full max-w-[350px] lg:max-w-[400px] xl:max-w-[500px] 2xl:max-w-[560px] 3xl:max-w-[780px] h-auto backdrop-blur-2xl ml-auto bg-white/10 border border-white/80 p-[20px_22px] xl:p-[25px_20px] 2xl:p-[30px_32px] 3xl:p-[35px_35px_32px_40px]">
                        {data?.title && (
