    ...
    <section className="w-full block relative">
      <div className="container max-sm:px-0">
        <div className="relative w-full h-[250px] md:h-[285px] xl:h-[350px] 2xl:h-[400px] 3xl:h-[500px] w-full flex items-end overflow-hidden px-[25px] py-5 xl:py-[30px]">
          ...
          {/* Content */}
          <div className={cn("relative z-1 w-auto max-w-[350px] lg:max-w-[400px] xl:max-w-[500px] 2xl:max-w-[560px] 3xl:max-w-[680px] h-auto backdrop-blur-2xl ml-auto bg-white/10 border border-white/80 p-[10px_15px] sm:p-[15px_20px] xl:p-[25px_20px] 2xl:p-[30px_32px] 3xl:p-[35px_35px_32px_40px] flex flex-col gap-y-1 xl:gap-y-2.5",
            data?.hero_media?.url ? "bg-white/10" : "bg-black/60"
          )}>
            {data?.title && (
