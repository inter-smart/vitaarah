    ...
    specialties: [
      {
        ...
        shortDescription:
          "Natural therapies to reduce pain and improve daily movement.",
        icon: {
          id: 9,
      ...
      },
      {
        ...
        shortDescription:
          "Gentle treatments to calm the mind and ease tension.",
        icon: {
          id: 8,
      ...
      },
      {
        ...
        shortDescription:
          "Balanced approaches to manage and improve overall health.",
        icon: {
          id: 7,
    ...
    treatments: [
      {
        ...
        slug: "panchakarma",
        shortDescription:
          "Natural treatments that eliminate toxins and refresh the body and mind.",
    ...
    members: [
      {
        ...
        title: "The Visionary",
        description:
          "An expert in Ayurveda with advanced degrees including MD and PhD, specializing in holistic healthcare.",
    ...
    blogs: [
      {
        ...
        shortDescription:
          "Together, they describe not merely a morning routine, but a complete science of aligning human biology with the rhythmic intelligence of nature.",
        featuredImage: {
          id: 20,
    ...
    packages: [
      {
        ...
        slug: "detox-program",
        shortDescription:
          "Focusing on cellular renewal through curated nourishment and molecular\ntherapies.",
        description: null,
      ...
      },
      {
        ...
        shortDescription:
          "Our flagship program highlighting restorative therapies and neurological reset protocols.",
        description: null,
      ...
      },
      {
        ...
        shortDescription:
          "A holistic escape integrating physical, mental, and spiritual alignment\npractices.",
        description: null,
...
export default async function Home() {
  ...
  return (
    <>
      ...
      {specialities && (
        <Reveal>
          <HomeSpecialities data={specialities} />
        </Reveal>
      )}
      {treatments && (
        <Reveal>
          <HomeTreatments data={treatments} />
        </Reveal>
      )}
      {packages && (
        <Reveal>
