...
const local_data = {
    ...
    statistics: {
        ...
        description: "Four curated pathways. Fifteen programs. Durations from 3 to 28 days — shaped around your body, your goals, and the time you carry",
        packagesStatistic: [
            {
                id: 89,
                valueCount: "4",
...
export default function PackagesPage() {
    return (
        <>
            ...
            {local_data.statistics && <PackagesStatistics data={local_data.statistics} />}
        </>
    )
}
