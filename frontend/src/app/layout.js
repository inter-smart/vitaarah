...
const LOCAL_FOOTER = {
  ...
  shortDescription:
    "Our approach to wellness is rooted in holistic healing, where the mind, body, and spirit are nurtured as one. We believe true health comes from achieving a natural balance within, aligning mental clarity with physical vitality. ",
  ...
  uaeAddress: "melbin@vitaarah.ae 202, API Business Suites, Al Barsha 1 ,Dubai",
  logo: {
    id: 30,
